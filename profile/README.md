...
[![Nexus](https://img.shields.io/badge/Nexus-22%2C624%20downloads-da8e35)](https://www.nexusmods.com/profile/DooDesch/mods)
<!-- TOTAL:END -->
...
|---|---|---|---|
| 2026-08-29 | Schedule I | **[Polyfill](https://github.com/DooDesch-Mods/ScheduleOne-Polyfill)** | [v0.11.3](https://github.com/DooDesch-Mods/ScheduleOne-Polyfill/releases/tag/v0.11.3) |
| 2026-08-28 | Palworld | **[Palworld-Palvolve](https://github.com/DooDesch-Mods/Palworld-Palvolve)** | [v1.9.0](https://github.com/DooDesch-Mods/Palworld-Palvolve/releases/tag/v1.9.0) |
| 2026-08-28 | Schedule I | **[Siesta](https://github.com/DooDesch-Mods/ScheduleOne-Siesta)** | [v1.2.3](https://github.com/DooDesch-Mods/ScheduleOne-Siesta/releases/tag/v1.2.3) |
| 2026-08-18 | Schedule I | **[Sideload](https://github.com/DooDesch-Mods/ScheduleOne-Sideload)** | [v1.32.0](https://github.com/DooDesch-Mods/ScheduleOne-Sideload/releases/tag/v1.32.0) |
...
| **[Hash](https://github.com/DooDesch-Mods/ScheduleOne-Hash)** | A terminal instead of the dev console: completion, arguments, output and history, on the... | [155](https://www.nexusmods.com/schedule1/mods/2408) |
| **[Hotline](https://github.com/DooDesch-Mods/ScheduleOne-Hotline)** | One overlay and one key for every mod's HUD - a framework + compatibility layer for Schedule I. | [231](https://www.nexusmods.com/schedule1/mods/2239) |
| **[Inkorporated](https://github.com/DooDesch-Mods/ScheduleOne-Inkorporated)** | Custom tattoo framework for Schedule I - mods add tattoos to the in-game tattoo shop via... | [452](https://www.nexusmods.com/schedule1/mods/2214) |
| **[Inkubator](https://github.com/DooDesch-Mods/ScheduleOne-Inkubator)** | In-game 3D tattoo editor for Schedule I: import PNGs, place them on the character, preview... | [338](https://www.nexusmods.com/schedule1/mods/2233) |
...
| **[Personify](https://github.com/DooDesch-Mods/ScheduleOne-Personify)** | In-game NPC editor for Schedule I - design NPCs live, export Personnel packs. | [359](https://www.nexusmods.com/schedule1/mods/2276) |
| **[Personnel](https://github.com/DooDesch-Mods/ScheduleOne-Personnel)** | The NPC framework for Schedule I - NPC packs as plain folders, spawned by mods as real S1API... | [361](https://www.nexusmods.com/schedule1/mods/2275) |
| **[Polyfill](https://github.com/DooDesch-Mods/ScheduleOne-Polyfill)** | Keeps older Schedule I mods working after a game update. | [2,463](https://www.nexusmods.com/schedule1/mods/2452) |
| **[PropHunt](https://github.com/DooDesch-Mods/ScheduleOne-PropHunt)** | Multiplayer prop hunt for Schedule I - hide as a prop or hunt them down. | [130](https://www.nexusmods.com/schedule1/mods/2283) |
...
| **[SideHustle](https://github.com/DooDesch-Mods/ScheduleOne-SideHustle)** | A main-menu hub that lists installed gamemode mods and launches them without a savegame. | [798](https://www.nexusmods.com/schedule1/mods/2232) |
| **[Sideload](https://github.com/DooDesch-Mods/ScheduleOne-Sideload)** | Write Schedule I mod interfaces as HTML, CSS and JavaScript. | [709](https://www.nexusmods.com/schedule1/mods/2360) |
| **[Siesta](https://github.com/DooDesch-Mods/ScheduleOne-Siesta)** | NPC performance LOD for Schedule I - hides and pauses distant, off-screen NPCs for more FPS... | [569](https://www.nexusmods.com/schedule1/mods/2210) |
| **[Snitch](https://github.com/DooDesch-Mods/ScheduleOne-Snitch)** | A performance profiler for Schedule I - cost + state of NPCs, trash, quests and your own... | [247](https://www.nexusmods.com/schedule1/mods/2222) |
| **[TightBeam](https://github.com/DooDesch-Mods/ScheduleOne-TightBeam)** | A believable, limited-range handheld flashlight for Schedule I with a cross-mod control API. | [496](https://www.nexusmods.com/schedule1/mods/2255) |
| **[WhatsDab](https://github.com/DooDesch-Mods/ScheduleOne-WhatsDab)** | Chat on the Schedule I phone. Threads, unread counts, group and one to one, in both... | [317](https://www.nexusmods.com/schedule1/mods/2361) |
| **[Yoink](https://github.com/DooDesch-Mods/ScheduleOne-Yoink)** | A hand winch for Schedule I - hook anything at the exact point you aimed at and reel it out... | [290](https://www.nexusmods.com/schedule1/mods/2377) |
...
| Mod | What it does |
|---|---|
| **[HotlineExample](https://github.com/DooDesch-Mods/ScheduleOne-HotlineExample)** | Modder example for Hotline - register a panel in the unified overlay (no-op when Hotline is... |
| **[InkorporatedExample](https://github.com/DooDesch-Mods/ScheduleOne-InkorporatedExample)** | Example + template for the Inkorporated tattoo framework (Schedule I): a no-code pack and a... |
| **[L10n](https://github.com/DooDesch-Mods/ScheduleOne-L10n)** | Tiny single-file localization for Schedule I MelonLoader mods - built-in tables... |
| **[SnitchExample](https://github.com/DooDesch-Mods/ScheduleOne-SnitchExample)** | Example + modder API (Snitch.cs shim) for the Snitch Schedule I performance profiler. |
| **[Stash](https://github.com/DooDesch-Mods/ScheduleOne-Stash)** | Public shared source for DooDesch's Schedule I mods (starts with the FullHouse lobby-cap... |
...
| Mod | What it does | Downloads |
|---|---|--:|
| **[BetterJump](https://github.com/DooDesch-Mods/Mimesis-BetterJump)** | Mimesis - tweakable jumping. | [115](https://www.nexusmods.com/mimesis/mods/5) |
...
| **[EnemyDropLoot](https://github.com/DooDesch-Mods/Mimesis-EnemyDropLoot)** | Mimesis - enemies drop loot. | [179](https://www.nexusmods.com/mimesis/mods/6) |
| **[FakePlayer](https://github.com/DooDesch-Mods/Mimesis-FakePlayer)** | Mimesis - add fake players to a lobby (handy for testing). | |
| **[InventoryExpansion](https://github.com/DooDesch-Mods/Mimesis-InventoryExpansion)** | Mimesis - a bigger inventory. | [253](https://www.nexusmods.com/mimesis/mods/8) |
| **[MarkerMod](https://github.com/DooDesch-Mods/Mimesis-MarkerMod)** | Mimesis - in-world markers / pings. | [74](https://www.nexusmods.com/mimesis/mods/7) |
...
| Mod | What it does | Downloads |
|---|---|--:|
| **[Palworld-Palvolve](https://github.com/DooDesch-Mods/Palworld-Palvolve)** | Conditional evolutions for Palworld: your Pals evolve when you choose, under conditions you set. | [2,774](https://www.nexusmods.com/palworld/mods/3976) |
<!-- MODS:END -->
...
| Project | What it is |
|---|---|
| **[PalCodex](https://github.com/DooDesch-Mods/PalCodex)** | PalCodex - a community-curated knowledge base for modding Palworld 1.0, with credit to every... |
| **[ScheduleOne-Cookbook](https://github.com/DooDesch-Mods/ScheduleOne-Cookbook)** | The community cookbook for modding Schedule I: code snippets, FishNet networking, IL2CPP... |
| **[ScheduleOne-Docs](https://github.com/DooDesch-Mods/ScheduleOne-Docs)** | Documentation for the DooDesch Schedule I mods - overview, guides and generated API... |
| **[ScheduleOne-SnitchWeb](https://github.com/DooDesch-Mods/ScheduleOne-SnitchWeb)** | Live web dashboard for the Snitch Schedule I performance profiler - auto-connects to a local... |
| **[SideHustle-Backend](https://github.com/DooDesch-Mods/SideHustle-Backend)** | Backend for Side Hustle: the lobby directory behind the in-game browser, a mod-manifest... |
<!-- TOOLS:END -->
...
Open an issue on the mod's repo, or reach me at [support.doodesch.de](https://support.doodesch.de).
Lemme know if anything breaks - I read everything, even if it takes me a bit (busy days happen 😅).
